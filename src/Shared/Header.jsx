...
import { FaBell, FaEnvelope, FaUserCircle, FaBars, FaTimes, FaHome, FaMoneyBill, FaCalendarAlt, FaCog, FaSignOutAlt, FaBuilding, FaIdCard, FaCamera } from "react-icons/fa";
...
const Header = () => {
    ...
    // Navigation items based on user role - Systematic Organization
    const adminNavItems = [
        ...
        { path: "/admin/projects", name: "Projects", icon: <VscProject /> },
        { path: "/employees", name: "Employees", icon: <FaPeopleGroup /> },
        { path: "/enhanced-attendance", name: "Attendance", icon: <FaCamera /> },
        ...
        { 
            ...
            icon: <FaCog />,
            subItems: [
                { path: "/admin/holidays", name: "Holiday Management", icon: <FaCalendarAlt /> },
                { path: "/id-card-generator", name: "ID Card Generator", icon: <FaIdCard /> },
                { path: "/admin/employee-codes", name: "Employee Codes", icon: <FaPeopleGroup /> }
            ]
        }
    ];
    ...
    const employeeNavItems = [
        ...
        { path: "/enhanced-attendance", name: "Attendance", icon: <FaCamera /> },
        { path: "/employee/project-dashboard", name: "My Projects", icon: <VscProject /> },
        { path: "/employee/projects", name: "All Projects", icon: <IoBookmarks /> },
                        ...
                        {item.subItems ? (
                            ...
                            <div className="relative">
                                <button
                                    ...
                                    className={`flex items-center justify-between w-full p-4 transition-colors duration-200 ${
                                        item.subItems.some(subItem => isActive(subItem.path)) ? 'bg-blue-600' : 'hover:bg-gray-700'
                                    }`}
                                >
                                    ...
                                    <div className="bg-gray-700">
                                        {item.subItems.map((subItem) => (
                                            <Link
                                                key={subItem.path}
                                                to={subItem.path}
                                                className={`flex items-center p-3 pl-12 transition-colors duration-200 ${
                                                    isActive(subItem.path) ? 'bg-blue-600' : 'hover:bg-gray-600'
                                                }`}
                                            >
