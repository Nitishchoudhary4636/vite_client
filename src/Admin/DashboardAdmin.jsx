...
//   useEffect(() => {
//   fetch('https://server-f8bw.onrender.com') // Replace with your actual backend URL
//     .then((res) => res.json())
//     .then((data) => {
      ...
      <div className={`flex-1 p-4 md:p-8 transition-all duration-300 ${mainContentMargin}`}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mb-6 md:mb-8">
          {statsLoading ? (
            ...
            <>
              {[1, 2, 3].map((index) => (
                <div key={index} className="bg-white p-4 md:p-6 rounded-xl shadow-md border-l-4 border-gray-200">
                  <div className="flex items-center">
                    <div className="p-2 md:p-3 rounded-full bg-gray-200 mr-3 md:mr-4 animate-pulse">
                      <div className="w-6 h-6 bg-gray-300 rounded"></div>
                    </div>
                    <div className="space-y-2">
                      <SkeletonLoader type="text" height="h-4" width="w-20" />
