...
import DepartmentManagement from './Admin/Department/DepartmentManagement';
import HolidayManagement from './Admin/Holiday/HolidayManagement';
import EnhancedAttendanceDashboard from './Both/EnhancedAttendanceDashboard';
import IDCardGenerator from './Both/IDCardGenerator';
import EmployeeCodeManagement from './Admin/Employee/EmployeeCodeManagement';
            ...
            <div style={{ display: 'flex' }}>
                ...
                <div style={{ flex: 1 }}>
                    <Routes>
                        ...
                        <Route path="/employee/project-dashboard" element={<EmployeeProjectDashboard />} />
                        
                        {/* Admin New Features */}
                        <Route path="/admin/departments" element={<DepartmentManagement />} />
                        <Route path="/admin/holidays" element={<HolidayManagement />} />
                        <Route path="/admin/employee-codes" element={<EmployeeCodeManagement />} />
                        <Route path="/admin/projects" element={<AdminProjectManagement />} />
                        <Route path="/admin-settings" element={<AdminSettings />} />
                        
                        {/* Manager Features */}
                        <Route path="/manager/projects" element={<ManagerProjectDashboard />} />
                        
                        {/* Employee Tools */}
                        <Route path="/employee-settings" element={<EmployeeTools />} />
                        
                        {/* Both Admin and Employee Features */}
                        <Route path="/enhanced-attendance" element={<EnhancedAttendanceDashboard />} />
